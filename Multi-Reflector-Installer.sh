...
YSF2DMRREPO=https://github.com/snailwalk11/MMDVM_CM.git
YSFREPO=https://github.com/snailwalk11/YSFClients.git
YSFDASHREPO=https://github.com/snailwalk11/YSFReflector-Dashboard.git
...
then
   ...
   echo "------------------------------------------------------------------------------"
   cd $YSFINTDIR
   git clone https://github.com/snailwalk11/YSFClients.git
